...
const SidebarSubItem = ({
  ...
  const hasRole = (role) => {
    if (user?.authorities?.includes("ROLE_SUPER_ADMIN")) return true;
    if (
      subItem.menu == "Bağış Gelirleri" ||
      subItem.menu == "Burs Giderleri" ||
      subItem.menu == "Yardım Giderleri"
    ) {
      return true;
    }
